...
1. **No guessing.** Every endpoint/behavior claim needs evidence: app traffic, APK smali/strings
   reference, or a reference-repo commit (with link). Otherwise mark it `BELUM TERVERIFIKASI` +
   TODO.
